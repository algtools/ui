...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default web preview component displaying an external URL with toolbar and fullscreen support enabled.',
      },
    },
  },
};
...
export const WithHTMLContent: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Web preview displaying inline HTML content instead of an external URL, useful for previewing AI-generated HTML.',
      },
    },
  },
};
...
export const LoadingState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Web preview in loading state, showing a loading indicator while content is being fetched or rendered.',
      },
    },
  },
};
...
export const WithoutToolbar: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Web preview without toolbar, providing a clean, minimal display focused solely on the content.',
      },
    },
  },
};
...
export const CustomDimensions: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Web preview with custom width and height dimensions, allowing precise control over the preview size.',
      },
    },
  },
};
...
export const AIGeneratedLandingPage: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Complete HTML landing page generated by AI, demonstrating how the preview component handles full HTML documents with styles and structure.',
      },
    },
  },
};
...
export const ResponsiveWebsite: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Responsive website layout with adaptive grid system, demonstrating how the preview handles responsive design patterns.',
      },
    },
  },
};
...
export const InteractiveWithControls: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive web preview with external controls, demonstrating how to programmatically control fullscreen and loading states.',
      },
    },
  },
};
...
export const MultiplePreviewsGrid: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Multiple web previews displayed in a responsive grid layout, useful for comparing different design variations side-by-side.',
      },
    },
  },
};
...
export const WithExternalURL: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Web preview loading content from an external URL, demonstrating how the component handles live web pages.',
      },
    },
  },
};
